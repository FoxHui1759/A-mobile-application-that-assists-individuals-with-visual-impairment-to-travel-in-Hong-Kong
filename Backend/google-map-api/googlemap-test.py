...
def google_map_path(a: str, b: str, gmaps: googlemaps.Client):
    ...
    res = gmaps.directions(a, b, mode="walking", departure_time="now", alternatives=True, language="zh-HK")
...
def main():
    google_map_client = googlemaps.Client(key=os.getenv("GOOGLE_MAP_API_KEY"))
    # test the function
